...
================================================================================
ČÁST 10: STRUKTURA SOUBORŮ PROJEKTU
Při generování kompletního addonu musí AI vytvořit následující přesný seznam
souborů (BEZ jakýchkoliv číselných předpon jako "1. ", "2. " apod.):
 * BEHAVIOR PACK (BP):
   * manifest.json
   * blocks/filtr.json
   * entities/golem_inside.json
   * entities/mini_copper_golem.json
   * recipes/filtr.json
   * scripts/main.js
 * RESOURCE PACK (RP):
   * resource_pack_manifest.json
   * texts/cs_CZ.lang
   * texts/en_US.lang
 * DOKUMENTACE:
   * README.md
